...
const FirstPage = () => {
    ...
    contents: [
      {
        parts: [
          {
            text: question + "Explain the code and keep it short but detailed",
          },
        ],
      },
    ],
  ...
  const payload1 = {
    contents: [
      {
        parts: [
          { text: question + "Debug the code and give the corrected code" },
        ],
      },
    ],
  };
    ...
    contents: [
      {
        parts: [
          {
            text:
              question + "Give a hint to solve this problem and keep it brief",
          },
        ],
      },
    ],
